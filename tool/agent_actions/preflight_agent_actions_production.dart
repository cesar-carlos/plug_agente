...
///   dart run tool/agent_actions/preflight_agent_actions_production.dart --strict-com
library;
...
Future<void> main(List<String> args) async {
  ...
  print('');
  print('Next commands:');
  print('  dart run tool/agent_actions/agent_action_security_gate_checklist.dart [actionType]');
  print('  python tool/agent_actions/homologate_hub_agent_actions.py --run-contract-tests');
  print(
    '  python tool/agent_actions/homologate_hub_agent_actions.py --prepare-live-env --validate-live-env --run-live-tests',
  );
