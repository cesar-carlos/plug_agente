...
///   `dart run tool/e2e/export_e2e_secrets_from_local.dart --force`
library;
...
void main(List<String> args) {
  ...
  if (signing != null) {
    ...
    print('  Then: dart run tool/e2e/promote_e2e_signing_from_monorepo_env.dart');
  }
  ...
  if (tokenReady && signingReady && signingKeyReady) {
    print('Next: dart run tool/e2e/validate_live_hub_agent_actions_env.dart');
    exit(0);
  }
