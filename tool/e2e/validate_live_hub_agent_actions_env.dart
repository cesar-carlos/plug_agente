...
///
/// Usage: `dart run tool/e2e/validate_live_hub_agent_actions_env.dart`
///
...
void _printFixHints() {
  ...
  print('        dart run tool/e2e/export_e2e_secrets_from_local.dart');
  print('        dart run tool/e2e/promote_e2e_signing_from_monorepo_env.dart');
  print('  Fix token:   dart run tool/e2e/fetch_e2e_hub_token_from_local_config.dart --apply-token --force');
}
...
void main() {
  ...
  print('  Run: python tool/agent_actions/homologate_hub_agent_actions.py --run-live-tests');
