...
Future<void> main(List<String> args) async {
  if (args.contains('--help') || args.contains('-h')) {
    stdout.writeln('Usage: dart run tool/benchmarks/benchmark_odbc_gateway_encoding.dart [--json]');
    stdout.writeln('Runs: flutter test test/tool/odbc_gateway_encoding_benchmark_test.dart --tags perf');
    return;
  }
  ...
  final result = await Process.run(
    ...
    [
      'test',
      'test/tool/odbc_gateway_encoding_benchmark_test.dart',
      '--tags',
      'perf',
    ],
