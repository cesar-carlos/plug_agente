...
from tool.benchmarks.compare_benchmark_summary import compare_metrics, format_table
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not baseline_metrics:
        ...
        print("Promote a known-good run with: python tool/benchmarks/promote_benchmark_baseline.py --from <summary.json>")
