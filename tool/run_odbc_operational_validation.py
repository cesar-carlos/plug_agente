...
def build_validation_report(context: dict[str, str], steps: dict[str, dict[str, str]]) -> str:
    ...
    lines = lines[:lines.index("## Step Status") + 6]  # reset - actually let me rewrite cleanly
...
def main() -> int:
    ...
    steps: dict[str, dict[str, str]] = {
        ...
        "Benchmark": {
            ...
            "Command": "python tool/odbc_async_benchmark.py",
        ...
        "StreamingBenchmark": {
            ...
            "Command": "python tool/odbc_streaming_benchmark.py",
        ...
        "DriverMatrixBenchmark": {
            ...
            "Command": "python tool/odbc_driver_matrix_benchmark.py --output-directory <runDirectory>",
    ...
    try:
        ...
        template_exit = run_streaming(
            [
                "dart",
                "run",
                "tool/export_odbc_health_snapshot_template.dart",
                "--output",
        ...
        if args.run_driver_matrix_benchmark:
            def run_driver_matrix() -> int:
                return run_streaming(
                    [
                        sys.executable,
                        str(TOOL_DIR / "odbc_driver_matrix_benchmark.py"),
                        "--output-directory",
                        str(run_directory),
                    ],
