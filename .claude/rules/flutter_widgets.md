...
- ✅ In widgets, ensure:
  ...
  - clear focus/keyboard navigation for desktop flows
...
- ✅ Set `textCapitalization`, `keyboardType`, and `textInputAction` appropriately
- ✅ Prefer `onSubmitted` + focus traversal for keyboard-first desktop flows
- ✅ Keep validation + error presentation near the field (avoid “hidden” errors)
