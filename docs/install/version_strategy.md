...
| Script                         | Uso                                                                                                                                                         |
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `installer/update_version.py`  | Sincroniza versão em `setup.iss` e `app_version.g.dart` a partir do `pubspec.yaml`. Use no fluxo manual ou para validar sincronização sem gerar instalador. |
