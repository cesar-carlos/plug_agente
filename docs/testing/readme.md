...
- `tool/run_odbc_operational_validation.ps1` — preflight + worksheet ODBC.
- `tool/run_agent_actions_operational_gate.ps1` — gate local/CI sem hub.
- `tool/homologate_hub_agent_actions.ps1` — homologacao live opt-in.
