...
class CommandLineActionProcessRunner implements AgentActionLocalRunner {
  ...
  Future<Result<AgentActionProcessResult>> run({
    ...
    if (config is! CommandLineActionConfig) {
      return Failure(
        ActionValidationFailure.withContext(
          message: 'Command line process runner received an invalid action config.',
          context: {
    ...
    try {
      ...
      return Failure(
        ActionRuntimeFailure.withContext(
          ...
          context: {
            ...
            'user_message': 'Nao foi possivel iniciar o comando. Verifique o comando e o diretorio de trabalho.',
          },
        ),
      );
      ...
      return Failure(
        ActionRuntimeFailure.withContext(
          message: 'Command line action process failed before completion.',
          cause: error,
          context: {
            'action_id': definition.id,
            ...AgentActionProcessInvocationDiagnostics.forInvocation(
            ...
            'user_message': 'Falha ao executar o comando. Verifique a configuracao da acao e tente novamente.',
          },
        ),
      );
    } finally {
