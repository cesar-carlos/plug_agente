...
class RpcProtocolMeta {
  ...
  factory RpcProtocolMeta.fromJson(Map<String, dynamic> json) {
    return RpcProtocolMeta(
      ...
      outboundCompression: json['outbound_compression'] as String?,
    );
  }
  ...
  /// Optional agent->hub PayloadFrame compression hint (`none`, `gzip`, `auto`).
  final String? outboundCompression;
  ...
  Map<String, dynamic> toJson() {
    ...
    if (outboundCompression != null) {
      json['outbound_compression'] = outboundCompression;
    }
    return json;
  }
}
