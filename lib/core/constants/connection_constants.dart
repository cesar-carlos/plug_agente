...
abstract final class ConnectionConstants {
  ...
  static const Duration hubAccessTokenProactiveRefreshMargin = HubResilienceConstants.hubAccessTokenProactiveRefreshMargin;
  static const int hubReconnectFailureLogThrottleStride = HubResilienceConstants.hubReconnectFailureLogThrottleStride;
  static const int hubAvailabilityProbeSlowLogThresholdMs = HubResilienceConstants.hubAvailabilityProbeSlowLogThresholdMs;
  ...
  static const int defaultStreamingConnectReuseMaxEntries = OdbcConnectionConstants.defaultStreamingConnectReuseMaxEntries;
  ...
  static int get sqlExecuteMaterializedMaxEstimatedBytes => OdbcConnectionConstants.sqlExecuteMaterializedMaxEstimatedBytes;
  ...
  static const int defaultBulkInsertParallelRowThreshold = OdbcConnectionConstants.defaultBulkInsertParallelRowThreshold;
  static const bool defaultBulkInsertParallelEnabled = OdbcConnectionConstants.defaultBulkInsertParallelEnabled;
  static const bool defaultReadOnlyBatchNativePoolEnabled = OdbcConnectionConstants.defaultReadOnlyBatchNativePoolEnabled;
  ...
  static int get batchBulkInsertRecommendationThreshold => OdbcConnectionConstants.batchBulkInsertRecommendationThreshold;
  ...
  static String directOdbcConnectionCapacityStrategy() => OdbcConnectionConstants.directOdbcConnectionCapacityStrategy();
  ...
  static const int defaultPlaygroundStreamingMaxResultRows = OdbcConnectionConstants.defaultPlaygroundStreamingMaxResultRows;
  static int get playgroundStreamingMaxResultRows => OdbcConnectionConstants.playgroundStreamingMaxResultRows;
  static const int defaultPlaygroundStreamingUiWindowRows = OdbcConnectionConstants.defaultPlaygroundStreamingUiWindowRows;
  ...
  static const int capabilitiesNegotiationWatchdogMarginMs = SocketTransportConstants.capabilitiesNegotiationWatchdogMarginMs;
  ...
  static const int defaultMaxConcurrentRpcHandlersHeadroom = SocketTransportConstants.defaultMaxConcurrentRpcHandlersHeadroom;
  ...
  static const int clientTokenGetPolicyDefaultMaxPerMinute = SocketTransportConstants.clientTokenGetPolicyDefaultMaxPerMinute;
  static const int clientTokenGetPolicyDefaultMaxScopeKeys = SocketTransportConstants.clientTokenGetPolicyDefaultMaxScopeKeys;
  static const int socketLogPayloadSummaryThresholdBytes = SocketTransportConstants.socketLogPayloadSummaryThresholdBytes;
  static const int defaultSchemaValidationSkipAboveBytes = SocketTransportConstants.defaultSchemaValidationSkipAboveBytes;
  static int get schemaValidationSkipAboveBytes => SocketTransportConstants.schemaValidationSkipAboveBytes;
  static const int socketOutgoingContractValidationMaxBytes = SocketTransportConstants.socketOutgoingContractValidationMaxBytes;
  static const int defaultGzipIsolateThresholdBytes = SocketTransportConstants.defaultGzipIsolateThresholdBytes;
  static const int streamingChunkJsonIsolateThresholdBytes = SocketTransportConstants.streamingChunkJsonIsolateThresholdBytes;
  static const int streamingChunkRowIsolateThreshold = SocketTransportConstants.streamingChunkRowIsolateThreshold;
  static const int defaultRpcChunkJsonIsolateThresholdBytes = SocketTransportConstants.defaultRpcChunkJsonIsolateThresholdBytes;
  static int get rpcChunkJsonIsolateThresholdBytes => SocketTransportConstants.rpcChunkJsonIsolateThresholdBytes;
  static const int defaultRpcChunkGzipIsolateThresholdBytes = SocketTransportConstants.defaultRpcChunkGzipIsolateThresholdBytes;
  static int get rpcChunkGzipIsolateThresholdBytes => SocketTransportConstants.rpcChunkGzipIsolateThresholdBytes;
  static const int defaultRpcChunkCompressionThresholdBytes = SocketTransportConstants.defaultRpcChunkCompressionThresholdBytes;
  ...
  static const int defaultProtocolMetricsRpcChunkSampleRate = SocketTransportConstants.defaultProtocolMetricsRpcChunkSampleRate;
  static int get protocolMetricsRpcChunkSampleRate => SocketTransportConstants.protocolMetricsRpcChunkSampleRate;
  static const int defaultAuthorizationDecisionCacheTtlSeconds = SocketTransportConstants.defaultAuthorizationDecisionCacheTtlSeconds;
  ...
  static const int defaultRecommendedStreamPullWindowSize = SocketTransportConstants.defaultRecommendedStreamPullWindowSize;
  ...
  static Duration get agentActionRpcIdempotencyEntryTtl => ConnectionPersistenceConstants.agentActionRpcIdempotencyEntryTtl;
  ...
  static const Duration agentActionExecutionPurgeInterval = ConnectionPersistenceConstants.agentActionExecutionPurgeInterval;
  ...
  static Duration get agentActionCapturedOutputRetention => ConnectionPersistenceConstants.agentActionCapturedOutputRetention;
}
