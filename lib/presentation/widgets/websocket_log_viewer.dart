...
class WebSocketLogViewer extends StatelessWidget {
          ...
          child: Column(
            ...
            children: [
              Row(
                ...
                children: [
                  Text('WebSocket Messages', style: FluentTheme.of(context).typography.subtitle),
                  Row(
                    children: [
                      ToggleSwitch(
                      ...
                      Button(child: const Text('Clear'), onPressed: () => logProvider.clearMessages()),
                    ],
                  ),
                ],
              ),
              ...
              Expanded(
                child: logProvider.messages.isEmpty
                    ? Center(child: Text('No messages yet', style: FluentTheme.of(context).typography.body))
                    : ListView.builder(
                        reverse: false,
  ...
  Widget _buildMessageItem(BuildContext context, WebSocketMessage message) {
    ...
    final color = isSent ? theme.accentColor : (theme.brightness == Brightness.dark ? Colors.white : Colors.black);
        ...
        children: [
          Row(
            children: [
              ...
              Text(message.event, style: FluentTheme.of(context).typography.bodyStrong),
            ],
          ),
          const SizedBox(height: 8),
          SelectableText(
            message.formattedData,
            style: FluentTheme.of(context).typography.caption?.copyWith(fontFamily: 'Consolas', fontSize: 11),
          ),
        ],
      ),
    );
