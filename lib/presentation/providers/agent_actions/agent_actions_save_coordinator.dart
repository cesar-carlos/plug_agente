...
final class AgentActionsSaveCoordinator {
  AgentActionsSaveCoordinator({
    ...
    AgentActionDefinitionAssembler assembler = const AgentActionDefinitionAssembler(),
       ...
       _persistence = _AgentActionDefinitionPersistence(
  ...
  final _AgentActionDefinitionPersistence _persistence;
  ...
  Future<bool> saveCommandLineAction({
    ...
    options: options,
    persist: (common) => _persistence.saveCommandLineAction(
  ...
  Future<bool> saveExecutableAction({
    ...
    options: options,
    persist: (common) => _persistence.saveExecutableAction(
      host: _definitionsController,
      name: name,
  ...
  Future<bool> saveScriptAction({
    ...
    options: options,
    persist: (common) => _persistence.saveScriptAction(
      host: _definitionsController,
      name: name,
  ...
  Future<bool> saveJarAction({
    ...
    options: options,
    persist: (common) => _persistence.saveJarAction(
      host: _definitionsController,
      name: name,
      jarPath: jarPath,
      arguments: arguments,
  ...
  Future<bool> saveEmailAction({
    ...
    options: options,
    persist: (common) => _persistence.saveEmailAction(
      host: _definitionsController,
      name: name,
  ...
  Future<bool> saveComObjectAction({
    ...
    options: options,
    persist: (common) => _persistence.saveComObjectAction(
      host: _definitionsController,
      name: name,
      progId: progId,
  ...
  Future<bool> saveDeveloperData7Action({
    ...
    options: options,
    persist: (common) => _persistence.saveDeveloperData7Action(
      host: _definitionsController,
      name: name,
...
final class _AgentActionDefinitionPersistence {
  _AgentActionDefinitionPersistence({
    required SaveAgentActionDefinition saveDefinition,
    required Uuid uuid,
    required DateTime Function() now,
    required String Function(Exception failure) messageFor,
