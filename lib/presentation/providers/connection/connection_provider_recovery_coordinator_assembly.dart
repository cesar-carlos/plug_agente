...
void assembleConnectionProviderRecoveryCoordinators({
  required ConnectionProviderCoordinatorAssemblyInput input,
  required ConnectionProviderCoordinatorAssemblyScratch scratch,
  required ConnectionProviderResilienceLogPrefix logResiliencePrefix,
  ...
  required ConnectionProviderTryRefreshToken tryRefreshToken,
}) {
...
Future<void> disconnectTransportForConnectionProviderRecovery({
...
Future<TokenRefreshResult> tryRefreshConnectionProviderToken({
