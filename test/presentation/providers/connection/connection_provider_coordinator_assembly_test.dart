...
ConnectionProviderCoordinatorAssemblyInput _assemblyInput({
  ...
  required ConnectionDisplayState displayState,
  required HubConnectionTrackingState trackingState,
  required HubRecoveryUiSink uiSink,
}) {
  return ConnectionProviderCoordinatorAssemblyInput(
...
void main() {
  ...
  late ConnectionDisplayState displayState;
  late HubConnectionTrackingState trackingState;
  late PresentationConnectionContextSource contextSource;
  ...
  setUp(() {
    ...
    contextSource = PresentationConnectionContextSource(trackingState: trackingState);
  ...
  group('assembleConnectionProviderCoordinators', () {
    test('wires circular late dependencies without throwing', () {
      expect(
        () => assembleConnectionProviderCoordinators(
          _assemblyInput(
    ...
    test('returns bundle with all coordinators initialized', () {
      final bundle = assembleConnectionProviderCoordinators(
        _assemblyInput(
          connectToHub: connectToHub,
          transportClient: transportClient,
          contextSource: contextSource,
