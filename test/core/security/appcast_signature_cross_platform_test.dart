...
void main() {
  group('Cross-platform Ed25519 verification (Python ↔ Dart)', () {
    // These vectors are produced by tool/appcast/appcast_signing.py against the same
    ...
    // Regenerate with:
    //   python -c "from tool.appcast.appcast_signing import *; ..."
    // If this test fails, the canonical format diverged between languages.
    test('verifies a signature produced by tool/appcast/appcast_signing.py', () async {
